      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>you can find your type of bike here.</h1>
            <p>==>>LET'S GO TO RIDE.</p>
            </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <p>“A motorcycle is like a drug but it doesn’t clog your arteries, impair your brain function, or send you to a rehabilitation centre. Plus, it’s completely legal (if you have a licence).”</p>
      <p>"The passion or love for riding can be seen through the love and care any motorcycling enthusiast or biker showers on his or her machine."</p>
    </div>
    <div class="row">
